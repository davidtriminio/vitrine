...
namespace Vitrine.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260901180459_OfferDetailBackground")]
    partial class OfferDetailBackground
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vitrine.Domain.Offers.Offer", b =>
                {
                    ...
                    b.Property<double?>("DetailBackgroundImageOpacity")
                        .HasColumnType("REAL");

                    b.Property<string>("DetailBackgroundImageUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("TEXT");
